...
class Server:
    ...
    def evaluate(self, iter, save=True, selected=False):
        ...
        self.logging.info("Average Global Accuracy = {:.4f}, Loss = {:.2f}.".format(glob_acc, glob_loss))
        self.logging.info("Best Global Accuracy = {:.4f}, Loss = {:.2f}, Iter = {:}.".format(self.best_accu, self.best_loss, self.best_iter))
