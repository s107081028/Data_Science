...
# alpha0.1: 
python main.py --dataset CIFAR10-alpha0.1-ratio1.0-users10 --algorithm FedAvg --num_glob_iters 150 --local_epochs 10 --num_users 10 --learning_rate 0.1 --model resnet18 --device cuda

# 2. Number of users in a round:
# 2 users: 
python main.py --dataset CIFAR10-alpha50.0-ratio1.0-users10 --algorithm FedAvg --num_glob_iters 150 --local_epochs 10 --num_users 2 --learning_rate 0.1 --model resnet18 --device cuda
# 10 users: 
python main.py --dataset CIFAR10-alpha50.0-ratio1.0-users10 --algorithm FedAvg --num_glob_iters 150 --local_epochs 10 --num_users 10 --learning_rate 0.1 --model resnet18 --device cuda
